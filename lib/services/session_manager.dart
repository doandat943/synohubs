...
class SessionManager extends ChangeNotifier {
  ...
  Future<String?> login({
    ...
    try {
      final resp = await _api!.login(account, password);
  ...
  /// Uses a temporary DSM session since FileStation session can't query
  /// SYNO.Core.User. The main FileStation session is preserved.
